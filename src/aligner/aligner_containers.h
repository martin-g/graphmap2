...
class AlignmentPosition {
 public:
  ...
  AlignmentPosition(int64_t _qstart, int64_t _qend, int64_t _tstart, int64_t _tend) :
  ...
  int64_t qstart, qend;              // Query and target alignment start and end positions. End position
  int64_t tstart, tend;              // is inclusive (the position of the last base).
};
